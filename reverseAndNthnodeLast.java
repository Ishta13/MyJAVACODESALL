public class reverseAndNthnodeLast {
    public class Node{
        int data;
    ...
    public void reverse()
    {
        ...
        head=prev; //to have prev as curr
    }
    public void removenthnode(int n)
    {
        ...
        {
            temp=temp.next; 
            sz++;  //to calculate size
        }
        if(n==sz)
        {
            head=head.next;
            return; //first node remove
        }
        int i=1;
        int iTofind = sz-n;
        Node prev=head; //to move till prev
        while(i<iTofind)
        {
            prev=prev.next; //move till nth node -1
            i++;

        }
        prev.next = prev.next.next; //remove the term
        return;
    ...
    public static void main(String[] args) {
       reverseAndNthnodeLast ll = new reverseAndNthnodeLast();
       ll.print();
       ll.addFirst(12);
       ll.print(); // 12->null
       ll.addFirst(11);
